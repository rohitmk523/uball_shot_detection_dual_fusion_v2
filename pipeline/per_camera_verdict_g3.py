#!/usr/bin/env python3
"""Per-camera ensemble layer for game-3 (3398befc).

Cameras identical to game-1/2 -> reuse v4 calibration + same hoop bboxes
...
def main() -> int:
    ...
    ap.add_argument("--out", default=str(G3 / "ensemble_results.json"))
    args = ap.parse_args()
